...
const Join = () => {
    ...
    if (!checkCode && user.userEmail !== "") {
      intervalId = setInterval(function () {
        if (timer + 1 === 0) {
          ...
          setTimer(timer - 1);
          setSec((timer % 60).toString().padStart(2, 0));
  ...
  // 이용약관 모달 설정
  const [chooseAgree, setChooseAgree] = useState(0);
  ...
  return (
    <div className="userJoin-main">
      ...
      {isAgreeModalOpen ? (
        ...
        >
          <div className="modal-agreeModal">
            {chooseAgree === 1 ? (
              <AgreeModal
                title={"이용약관 동의"}
                type={chooseAgree}
                setChooseAgree={setChooseAgree}
...
const AgreeModal = (props) => {
  const { title, type, setChooseAgree, setIsAgreeModalOpen } = props;
  return (
        ...
        {type === 1 ? (
          <>
            <div>
              <h5>제1조(목적)</h5>
              <p>
                이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 Spoon &
                Smiles(이하 “SAS”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
                “서비스”라 한다)를 이용함에 있어 사이버 SAS과 이용자의 권리․의무
            ...
            <div>
              <h5>제2조(정의)</h5>
              <p>
                ① “SAS”이란 업체 회사가 재화 또는 용역(이하 “재화 등”이라 함)을
                이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여
                재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러
                사이버SAS을 운영하는 사업자의 의미로도 사용합니다.
              </p>
              <p>
                ② “이용자”란 “SAS”에 접속하여 이 약관에 따라 “SAS”이 제공하는
                서비스를 받는 회원 및 비회원을 말합니다.
              </p>
              <p>
                ③ ‘회원’이라 함은 “SAS”에 회원등록을 한 자로서, 계속적으로
                “SAS”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
              </p>
              <p>
                ④ ‘비회원’이라 함은 회원에 가입하지 않고 “SAS”이 제공하는
                서비스를 이용하는 자를 말합니다.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                ② “SAS”은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의
              ...
              <p>
                ③ “SAS”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화
                등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그
                사유를 이용자에게 통지 가능한 주소로 즉시 통지합니다.
              </p>
              <p>
                ④ 전항의 경우 “SAS”은 이로 인하여 이용자가 입은 손해를
                배상합니다. 다만, “SAS”이 고의 또는 과실이 없음을 입증하는
                경우에는 그러하지 아니합니다.
              </p>
            </div>{" "}
            <div>
              ...
              <h5>제5조(서비스의 중단) </h5>
              <p>
                ① “SAS”은 컴퓨터 등 정보통신설비의 보수점검․교체 및 고장, 통신의
                두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로
                중단할 수 있습니다.{" "}
              </p>
              <p>
                ② “SAS”은 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로
                인하여 이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단,
                “SAS”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
                아니합니다.{" "}
              </p>
              <p>
                ③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로
                서비스를 제공할 수 없게 되는 경우에는 “SAS”은 제8조에 정한
                방법으로 이용자에게 통지하고 당초 “SAS”에서 제시한 조건에 따라
                소비자에게 보상합니다. 다만, “SAS”이 보상기준 등을 고지하지
                아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 “SAS”에서
            ...
            <div>
              <h5>제6조(회원가입) </h5>
              <p>
                ① 이용자는 “SAS”이 정한 가입 양식에 따라 회원정보를 기입한 후 이
                약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.{" "}
              </p>
              <p>
                ② “SAS”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중
                다음 각 호에 해당하지 않는 한 회원으로 등록합니다. <br />
                1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을
                상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실 후
                3년이 경과한 자로서 “SAS”의 회원재가입 승낙을 얻은 경우에는
                예외로 한다. <br />
                2. 등록 내용에 허위, 기재누락, 오기가 있는 경우 <br />
                3. 기타 회원으로 등록하는 것이 “SAS”의 기술상 현저히 지장이
                있다고 판단되는 경우{" "}
              </p>
              <p>
                ③ 회원가입계약의 성립 시기는 “SAS”의 승낙이 회원에게 도달한
                시점으로 합니다.{" "}
              </p>
              <p>
                ④ 회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간
                이내에 “SAS”에 대하여 회원정보 수정 등의 방법으로 그 변경사항을
                알려야 합니다.{" "}
              </p>
            </div>{" "}
            <div>
              ...
              <p>
                ① 회원은 “SAS”에 언제든지 탈퇴를 요청할 수 있으며 “SAS”은 즉시
                회원탈퇴를 처리합니다.{" "}
              </p>
              <p>
                ② 회원이 다음 각 호의 사유에 해당하는 경우, “SAS”은 회원자격을
                제한 및 정지시킬 수 있습니다. <br />
                1. 가입 신청 시에 허위 내용을 등록한 경우 <br />
                2. “SAS”을 이용하여 구입한 재화 등의 대금, 기타 “SAS”이용에
                관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우 <br />
                3. 다른 사람의 “SAS” 이용을 방해하거나 그 정보를 도용하는 등
                전자상거래 질서를 위협하는 경우 <br />
                4. “SAS”을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에
                반하는 행위를 하는 경우{" "}
              </p>
              <p>
                ③ “SAS”이 회원 자격을 제한․정지 시킨 후, 동일한 행위가 2회 이상
                반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “SAS”은
                회원자격을 상실시킬 수 있습니다.{" "}
              </p>
              <p>
                ④ “SAS”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다.
            ...
            <div>
              <h5>제8조(회원에 대한 통지) </h5>
              <p>
                ① “SAS”이 회원에 대한 통지를 하는 경우, 회원이 “SAS”과 미리
                약정하여 지정한 전자우편 주소로 할 수 있습니다.{" "}
              </p>
              <p>
                ② “SAS”은 불특정다수 회원에 대한 통지의 경우 1주일이상 “SAS”
            ...
            <div>
              <h5>제9조(구매신청) </h5>
              <p>
                ① “SAS”이용자는 “SAS”상에서 다음 또는 이와 유사한 방법에 의하여
                예약을 신청하며, “SAS”은 이용자가 예약신청을 함에 있어서 다음의
                각 내용을 알기 쉽게 제공하여야 합니다. <br />
                1. 재화 등의 검색 및 선택 <br />
                2. 예약자의 성명, 전화번호, 전자우편주소(또는 이동전화번호) 등의
                입력 <br />
                3. 약관내용, 청약철회권이 제한되는 서비스, 예약금 등의
                비용부담과 관련한 내용에 대한 확인 <br />
                4. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시
                (예, 마우스 클릭) <br />
                5. 재화 등의 예약신청 및 이에 관한 확인 또는 “SAS”의 확인에 대한
                동의 <br />
                6. 결제방법의 선택{" "}
              </p>
              <p>
                ② “SAS”이 제3자에게 구매자 개인정보를 제공·위탁할 필요가 있는
                경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시
                미리 포괄적으로 동의를 받지 않습니다. 이 때 “SAS”은 제공되는
            ...
            <div>
              <h5>제10조 (계약의 성립) </h5>
              <p>
                ① “SAS”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면
                ...
                용역을 구매하는 경우 <br />
                3. 기타 구매신청에 승낙하는 것이 “SAS” 기술상 현저히 지장이
                있다고 판단하는 경우
              </p>
              <p>
                ② “SAS”의 승낙이 제12조제1항의 수신확인통지형태로 이용자에게
                도달한 시점에 계약이 성립한 것으로 봅니다.{" "}
              </p>
              <p>
                ③ “SAS”의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및
            ...
            <div>
              <h5>제11조(지급방법) </h5>
              “SAS”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의
              방법중 가용한 방법으로 할 수 있습니다. 단, “SAS”은 이용자의
            ...
            <div>
              ...
              <p>
                ① “SAS”은 이용자의 구매신청이 있는 경우 이용자에게
                수신확인통지를 합니다.{" "}
              </p>
              <p>
                ② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는
                경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를
                요청할 수 있고 “SAS”은 배송 전에 이용자의 요청이 있는 경우에는
            ...
            <div>
              <h5>제13조(재화 등의 공급) </h5>
              <p>
                ① “SAS”은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이
                없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할
                수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만,
                “SAS”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는
                대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 조치를
                취합니다. 이때 “SAS”은 이용자가 재화 등의 공급 절차 및 진행
                사항을 확인할 수 있도록 적절한 조치를 합니다.{" "}
              </p>
              <p>
                ② “SAS”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용
                부담자, 수단별 배송기간 등을 명시합니다. 만약 “SAS”이 약정
                배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야
                합니다. 다만 “SAS”이 고의․과실이 없음을 입증한 경우에는 그러하지
                아니합니다.
              </p>
            </div>
            <div>
              <h5>제14조(환급) </h5>
              “SAS”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는
            ...
            <div>
              <h5>제15조(청약철회 등) </h5>
              <p>
                ① “SAS”과 재화등의 구매에 관한 계약을 체결한 이용자는
              ...
              <p>
                ③ 제2항제2호 내지 제4호의 경우에 “SAS”이 사전에 청약철회 등이
            ...
            <div>
              ...
              <p>
                ① “SAS”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에
                이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “SAS”이
              ...
              <p>
                ② “SAS”은 위 대금을 환급함에 있어서 이용자가 신용카드 또는
              ...
              <p>
                ...
                이용자가 부담합니다. “SAS”은 이용자에게 청약철회 등을 이유로
                위약금 또는 손해배상을 청구하지 않습니다. 다만 재화 등의 내용이
                표시·광고 내용과 다르거나 계약내용과 다르게 이행되어 청약철회
                등을 하는 경우 재화 등의 반환에 필요한 비용은 “SAS”이
                부담합니다.{" "}
              </p>
              <p>
                ④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 “SAS”은
            ...
            <div>
              <h5>제17조(개인정보보호) </h5>
              <p>
                ① “SAS”은 이용자의 개인정보 수집시 서비스제공을 위하여 필요한
                범위에서 최소한의 개인정보를 수집합니다.{" "}
              </p>
              <p>
                ② “SAS”은 회원가입시 구매계약이행에 필요한 정보를 미리 수집하지
                않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에
                본인확인이 필요한 경우로서 최소한의 특정 개인정보를 수집하는
                경우에는 그러하지 아니합니다.{" "}
              </p>
              <p>
                ③ “SAS”은 이용자의 개인정보를 수집·이용하는 때에는 당해
                이용자에게 그 목적을 고지하고 동의를 받습니다.
              </p>
              <p>
                ④ “SAS”은 수집된 개인정보를 목적외의 용도로 이용할 수 없으며,
              ...
              <p>
                ⑤ “SAS”이 제3항과 제4항에 의해 이용자의 동의를 받아야 하는
              ...
              <p>
                ⑥ 이용자는 언제든지 “SAS”이 가지고 있는 자신의 개인정보에 대해
                열람 및 오류정정을 요구할 수 있으며 “SAS”은 이에 대해 지체 없이
                필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한
                경우에는 “SAS”은 그 오류를 정정할 때까지 당해 개인정보를
                이용하지 않습니다.
              </p>
              <p>
                ⑦ “SAS”은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는
                자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한
                이용자의 개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조
                등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.
              </p>
              <p>
                ⑧ “SAS” 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의
                수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체
                없이 파기합니다.
              </p>
              <p>
                ⑨ “SAS”은 개인정보의 수집·이용·제공에 관한 동의란을 미리 선택한
            ...
            <div>
              ...
              <p>
                ...
                있음을 인지한 경우에는 바로 “SAS”에 통보하고 “SAS”의 안내가 있는
                경우에는 그에 따라야 합니다.
              </p>
            </div>
            <div>
              <h5>제20조(이용자의 의무) </h5>이용자는 다음 행위를 하여서는 안
              됩니다.
              <p>
                1. 신청 또는 변경시 허위 내용의 등록 <br />
                2. 타인의 정보 도용 <br />
                3. “SAS”에 게시된 정보의 변경 <br />
                4. “SAS”이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신
                또는 게시 <br />
                5. “SAS” 기타 제3자의 저작권 등 지적재산권에 대한 침해 <br />
                6. “SAS” 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
                <br />
                7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는
                정보를 SAS에 공개 또는 게시하는 행위
              </p>
            </div>
            <div>
              <h5>제21조(연결“SAS”과 피연결“SAS” 간의 관계) </h5>
              <p>
                ① 상위 “SAS”과 하위 “SAS”이 하이퍼링크(예: 하이퍼링크의 대상에는
                문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를
                연결 “SAS”(웹 사이트)이라고 하고 후자를 피연결
                “SAS”(웹사이트)이라고 합니다.
              </p>
              <p>
                ② 연결“SAS”은 피연결“SAS”이 독자적으로 제공하는 재화 등에 의하여
                이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을
                연결“SAS”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한
            ...
            <div>
              ...
              <p>
                ① “SAS“이 작성한 저작물에 대한 저작권 기타 지적재산권은 ”SAS“에
                귀속합니다.
              </p>
              <p>
                ② 이용자는 “SAS”을 이용함으로써 얻은 정보 중 “SAS”에게
                지적재산권이 귀속된 정보를 “SAS”의 사전 승낙 없이 복제, 송신,
                출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나
                제3자에게 이용하게 하여서는 안됩니다.
              </p>
              <p>
                ③ “SAS”은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우
                당해 이용자에게 통보하여야 합니다.
              </p>
            </div>
            <div>
              <h5>제23조(분쟁해결) </h5>
              <p>
                ① “SAS”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그
                피해를 보상처리하기 위하여 피해보상처리기구를 설치․운영합니다.
              </p>
              <p>
                ② “SAS”은 이용자로부터 제출되는 불만사항 및 의견은 우선적으로 그
                사항을 처리합니다. 다만, 신속한 처리가 곤란한 경우에는
                이용자에게 그 사유와 처리일정을 즉시 통보해 드립니다.
              </p>
              <p>
                ③ “SAS”과 이용자 간에 발생한 전자상거래 분쟁과 관련하여 이용자의
            ...
            <div>
              ...
              <p>
                ① “SAS”과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 제소
              ...
              <p>
                ② “SAS”과 이용자 간에 제기된 전자상거래 소송에는 한국법을
                적용합니다.
              </p>
            </div>
          </>
          ...
          <>
            ...
            <div>
              ...
              <p>
                ...
                이를 인터넷사이트 및 모바일 어플리케이션에 공개하여 이용자가
                언제나 용이하게 열람할 수 있도록 하고 있습니다. <br />
            ...
            <div>
              ...
              <p>
                귀하께서 본 사이트의 개인정보보호방침 또는 이용약관의 내용에
                대해 「동의 한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수
                있는 절차를 마련하여, 「동의 한다」버튼을 클릭하면 개인정보
                수집에 대해 동의한 것으로 봅니다.{" "}
              </p>
            </div>
            <div>
              <h5>3. 개인정보의 수집 및 이용목적 </h5>
              <p>
            ...
            <div>
              <h5>4. 수집하는 개인정보 항목 </h5>
              <p>
                본 사이트는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은
                개인정보를 수집하고 있습니다. <br />
            ...
            <div>
              ...
              <p>
                ...
                거부할 수 있는 선택권을 가질 수 있습니다. <br />
                2) 쿠키 등 사용 목적 : 이용자의 접속 빈도나 방문 시간 등을 분석,
                이용자의 취향과 관심분야를 파악 및 자취 추적, 각종 이벤트 참여
                ...
                저장을 거부할 수 있습니다. 설정방법 예시 : 인터넷 익스플로어의
                경우 → 웹 브라우저 상단의 도구 > 인터넷 옵션 > 개인정보 단,
                귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을
                수 있습니다.{" "}
              </p>
            </div>
            <div>
              <h5>6 목적 외 사용 및 제3자에 대한 제공 </h5>
              <p>
                본 사이트는 귀하의 개인정보를 "개인정보의 수집목적 및
                이용목적"에서 고지한 범위 내에서 사용하며, 동 범위를 초과하여
                이용하거나 타인 또는 타 기업·기관에 제공하지 않습니다. 그러나
                보다 나은 서비스 제공을 위하여 귀하의 개인정보를 업체 자회사
                또는 제휴사에게 제공하거나, 업체 자회사 또는 제휴사와 공유할 수
                있습니다. 개인정보를 제공하거나 공유할 경우에는 사전에 귀하께
                업체 자회사 그리고 제휴사가 누구인지, 제공 또는 공유되는
                ...
                개인정보를 원칙적으로 외부에 제공하지 않으나, 아래의 경우에는
                예외로 합니다. <br />
            ...
            <div>
              <h5>8. 개인정보 수집, 이용, 제공에 대한 동의철회 </h5>
              <p>
                회원가입 등을 통해 개인정보의 수집, 이용, 제공에 대해 귀하께서
                동의하신 내용을 귀하는 언제든지 철회하실 수 있습니다. 동의철회는
                "마이페이지"의 "회원탈퇴(동의철회)"를 클릭하거나
                개인정보관리책임자에게 E-mail등으로 연락하시면 즉시 개인정보의
                삭제 등 필요한 조치를 하겠습니다. 본 사이트는 개인정보의 수집에
                대한 회원탈퇴(동의철회)를 개인정보 수집시와 동등한 방법 및
                절차로 행사할 수 있도록 필요한 조치를 하겠습니다.{" "}
              </p>
            </div>
            <div>
              <h5>9. 개인정보의 보유 및 이용기간 </h5>
              <p>
                ...
                재가입하여 활동하지 못하도록 하기 위함 <br />
                3) 보존 기간 : 영구 <br />
                그리고 상법 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우
                회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 거래 및
                회원정보를 보관합니다. <br />
                ⚪보존 항목 : 계약 또는 청약철회 기록, 대금 결제 및 재화공급
                기록, 불만 또는 분쟁처리 기록 <br />
                ...
                귀하의 동의를 받겠습니다. <br />
                ⚪회원이 1년간 서비스 이용기록이 없는 경우[정보통신망 이용촉진
                및 정보보호 등에 관한 법률] 제 29조 '개인정보 유효 기간제'에
                따라 회원에게 사전 통지하고 별도로 분리하여 저장합니다. <br />
                4) 개인정보의 국외 보관에 대한 내용 회사는 이용자로부터 취득
                또는 생성한 개인정보를 미리내가 보유하고 있는 데이터베이스
                (물리적보관소: 한국)에 저장합니다. 미리내는 해당 서버의 물리적인
                관리만을 행하고, 원칙적으로 회원님의 개인정보에 접근하지
                않습니다. <br />
            ...
            <div>
              ...
              <p>
                ...
                이외의 다른 목적으로 이용되지 않습니다. <br />
                파기방법 : 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수
                없는 기술적 방법을 사용하여 삭제합니다.{" "}
              </p>
            </div>
            <div>
              <h5>11. 아동의 개인정보 보호 </h5>
              <p>
                본 사이트는 만14세 미만 아동의 개인정보를 수집하는 경우
                법정대리인의 동의를 받습니다. 만14세 미만 아동의 법정대리인은
                아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며,
                이러한 요청이 있을 경우 본 사이트는 지체 없이 필요한 조치를
                취합니다.{" "}
              </p>
            </div>
            <div>
              <h5>12. 개인정보 보호를 위한 기술적 대책 </h5>
              <p>
                본 사이트는 귀하의 개인정보를 취급함에 있어 개인정보가 분실,
                도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여
                다음과 같은 기술적 대책을 강구하고 있습니다. 귀하의 개인정보는
                비밀번호에 의해 보호되며, 파일 및 전송 데이터를 암호화하거나
                파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을
                통해 보호되고 있습니다. 본 사이트는 백신프로그램을 이용하여
                컴퓨터바이러스에 의한 피해를 방지하기 위한 조치를 취하고
                있습니다. 백신프로그램은 주기적으로 업데이트되며 갑작스런
                바이러스가 출현할 경우 백신이 나오는 즉시 이를 제공함으로써
                개인정보가 침해되는 것을 방지하고 있습니다. 해킹 등에 의해
                귀하의 개인정보가 유출되는 것을 방지하기 위해, 외부로부터의
                침입을 차단하는 장치를 이용하고 있습니다.{" "}
              </p>
            </div>
            <div>
              <h5>13. 개인정보의 위탁처리 </h5>
              <p>
                ...
                미리 그 사실을 귀하에게 고지하겠습니다. 개인정보의 처리를
                위탁하는 경우에는 위탁계약 등을 통하여 서비스제공자의
                개인정보보호 관련 지시 엄수, 개인정보에 관한 비밀유지, 제3자
                제공의 금지 및 사고시의 책임부담 등을 명확히 규정하고 당해
                계약내용을 서면 또는 전자적으로 보관하겠습니다.{" "}
              </p>
            </div>
            <div>
              <h5>14. 의견수렴 및 불만처리 </h5>
              <p>
                본 사이트는 개인정보보호와 관련하여 귀하가 의견과 불만을 제기할
                수 있는 창구를 개설하고 있습니다. 개인정보와 관련한 불만이
                있으신 분은 본 사이트의 개인정보 최고 관리책임자에게 의견을
                주시면 접수 즉시 조치하여 처리결과를 통보해 드립니다. <br />
                1) 개인정보 최고 관리책임자는 회사의 대표가 직접 맡아서
                개인정보에 대한 강조를 하고 있습니다. 개인정보를 보호하고 유출을
                방지하는 책임자로서 이용자가 안심하고 회사가 제공하는 서비스를
                이용할 수 있도록 도와드리며, 개인정보를 보호하는데 있어
                이용자에게 고지한 사항들에 반하여 사고가 발생할 시에는 이에 관한
                책임을 집니다. <br />
                2) 기술적인 보완조치를 취하였음에도 불구하고 악의적인 해킹 등
                기본적인 네트워크상의 위험성에 의해 발생하는 예기치 못한 사고로
                인한 정보의 훼손 및 멸실, 이용자가 작성한 게시물에 의한 각종
                분쟁 등에 관해서는, 본 사이트 회사는 책임이 없습니다. <br />
                3) 회사는 정보통신망 이용촉진 및 정보보호 등에 관한 법률에서
                규정한 관리책임자를 다음과 같이 지정합니다. <br />
                개인정보 최고 관리책임자 성명 : 김태관 <br />
                전화번호 : 010-0000-0000 <br />
                이메일 : admin@sas.co.kr <br />
                <br />
            ...
            <div>
              <h5>15. 부 칙(시행일) </h5>
              <p>
                현 개인정보처리방침은 2024년 9월 13일에 제정되었으며, 정부 및
                회사의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및
                수정이 있을 경우에는 개정 최소 7일 전부터 ‘공지사항’란을 통해
                고지하며, 본 정책은 시행 일자에 시행됩니다. <br />
                1) 공고일자 : 2024년 09월 13일 <br />
                2) 시행일자 : 2024년 09월 13일{" "}
              </p>
            </div>
          </>
        ) : (
